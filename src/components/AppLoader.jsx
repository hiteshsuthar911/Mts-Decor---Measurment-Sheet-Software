...
export default function AppLoader({ text = 'LOADING...', subtext = '' }) {
  return (
    <div className="d-flex flex-column align-items-center justify-content-center p-4">
      ...
      {text && (
        <div className="mt-2 text-dark fw-bolder text-uppercase extra-small tracking-wider" style={{ letterSpacing: '1px' }}>
          {text}
        </div>
      )}
      {subtext && (
