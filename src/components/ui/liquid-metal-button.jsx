  ...
  const dimensions = useMemo(() => {
    if (viewMode === "icon") {
      ...
      return {
        ...
        innerHeight: `${height - 4}px`,
      };
    } else {
      const w = width ? (typeof width === "number" ? `${width}px` : width) : "200px";
      const h = typeof height === "number" ? `${height}px` : height;
      return {
        width: w,
        height: h,
        innerWidth: typeof width === "number" ? `${width - 4}px` : "calc(100% - 4px)",
        innerHeight: typeof height === "number" ? `${height - 4}px` : "calc(100% - 4px)",
      };
    }
          ...
          >
            {loading && (
              <span
                ...
                style={{ width: "16px", height: "16px", borderWidth: "2px", color: "#ffffff" }}
                role="status"
              />
            )}
